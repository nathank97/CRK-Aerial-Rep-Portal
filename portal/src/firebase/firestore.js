...
export const inventoryBatchesCol = collection(db, 'inventoryBatches')
export const purchaseOrdersCol = collection(db, 'purchaseOrders')
export const inventoryTxCol = collection(db, 'inventoryTransactions')
...
export const modelsCol  = collection(db, 'models')
...
export const emailTemplatesDoc = doc(db, 'settings', 'emailTemplates')
