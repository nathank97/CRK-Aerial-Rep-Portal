        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-100 bg-[#F4F4F5]">
              <th className="text-left py-2 px-3 text-xs font-semibold text-[#9A9A9A] uppercase tracking-wider">Invoice #</th>
              ...
              <th className="text-center py-2 px-3 text-xs font-semibold text-[#9A9A9A] uppercase tracking-wider">Sent</th>
            ...
            {loading ? (
              ...
              filtered.map((inv) => {
                ...
                return (
                  ...
                  >
                    <td className="py-2 px-3 font-mono text-xs font-semibold text-[#8B6914]">{inv.invoiceNumber}</td>
                    ...
                    <td className="py-2 px-3 text-right font-semibold text-[#111111]">{formatCurrency(inv.total)}</td>
          ...
          filtered.map((inv) => {
            ...
            return (
              ...
              >
                ...
                {(inv.sentAt || inv.inventoryDeducted) && (
